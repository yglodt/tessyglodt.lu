...
<div class="box margin-top margin-bottom">
	<article class="text-box about_text">
		...
		<ul>
			...
			<li>Taschenführer durch die Burgen und Schlösser in Luxemburg, R. Bour</li>
			<li>Luxemburger Wanderbuch, Hemmer</li>
			<li>Von Bräuchen, Sitten und Aberglauben, P. Tousch</li>
			<li>Mosella Sacra, divers Auteuren</li>
			<li>Luxemburger Sagen und Legenden, Dicks, Gredt</li>
			<li>Mosella, Groben</li>
			<li>Wikipedia - Recherchen</li>
			<li>Der Legendenweg, divers Auteuren</li>
			<li>Marienkalender, Reportagen M. Thill</li>
			<li>legilux.lu (Detailler a.d. Memorial)</li>
			<li>Arbres remarquables, Forstverwaltung</li>
			<li>Kapellen, Cliärrwer Kanton, divers Auteuren</li>
			<li>Heimat und Mission 80 Jahre, N. Thill</li>
			<li>Chronik 963-1684, Fr. Lascombes</li>
			<li>Baugeschichte der Stadt und Festung Luxemburg, Koltz</li>
			<li>Echternach, P. Spang</li>
			<li>Marianische Geographie, Biel</li>
			<li>Wandern in Luxemburg., E. Friedrich</li>
			<li>Réiserbänner Chronik, divers Auteuren</li>
